...
The following endpoints let you view how many respondents answered a question a particular way and how many respondents answered a question a particular way in a given time period, for example a week.
...
------ | ------- | -------
collector_ids||Comma separated strings
start_created_at||Date String
end_created_at||Date String
start_modified_at||Date String
end_modified_at||Date String
status|Accepts: 'completed', 'partial', 'overquota', 'disqualified'|Comma separted strings 
email||String
first_name||String
last_name||String
ip||IP
custom||String
total_time_max||String
total_time_min||String
total_time_units|Accepts: 'second', 'minute', 'hour'|String
...
data[\_].summary.answered||Integer
data[\_].summary.skipped||Integer
data[\_].summary.stats||Object
data[\_].summary.other_answered||
data[\_].summary.choices||
...

{
  ...
  "data": [
    {
      "subtype": "rating",
      "skipped": 0,
      "href": "https://api.localmonkey.com/v3/surveys/1234/pages/1234/questions/1234/trends",
      "family": "matrix",
      "answered": 2,
      "trends": [
        {
  ...
  "page": 1,
  "links": {
    "self": "https://api.localmonkey.com/v3/surveys/1234/trends?page=1&per_page=50"
  }
}
...
Name | Description | Type
------ | ------- | -------
first_respondent||String
last_respondnet||String
trend_by|Accepts: 'year', 'quarter', 'month', 'week', 'day', 'hour'|String
collector_ids||Comma separated strings
start_created_at||Date String
end_created_at||Date String
start_modified_at||Date String
